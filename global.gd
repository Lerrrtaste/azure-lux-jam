...
const ORDER_ZOMBIE_THRESHOLD_END = 20 #spawn strongest zombie after x seconds
...
const INVENTORY_UPGRADE_COST_INCREASE = 15 #ignored on first upgrade, added twice on seconds upgrade etc
